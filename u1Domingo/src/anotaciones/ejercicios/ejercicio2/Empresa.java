...
@DirectivoAnotacion(empAnota=@EmpleadoAnotacion(apellidos = "Ortegazo", clase = "Directivo", direccion = "C/ A", dni = "74859612", nombre = "o", telefono = "987654321"),codigoDespacho=100)
@TecnicoAnotacion(empAnota=@EmpleadoAnotacion(apellidos = "Ortega", clase = "Directivo", direccion = "C/ A", dni = "74859612", nombre = "Amancio", telefono = "987654321"),perfil="Superior")
@OficialAnotacion(empAnota=@EmpleadoAnotacion(apellidos = "Orteguita", clase = "Tecnico", direccion = "", dni = "", nombre = "Amancito", telefono = "", codTaller = 100),categoria="Primera")
